...
<h3> Payment</h3>
    ...
    <input class="input-style" type="text" name="payment" value="Online Payment"/>
</div>

<div class="right-div">
<h3>Pay online </h3>
 <input class="input-style" type="text" name="transactionid" placeholder="Enter Trasaction Id" required="">
...
<div class="left-div">
<h3>Mobile Number</h3>
 <input class="input-style" type="number" name="mobileno" value="<%=rs2.getString(3) %>" placeholder="Enter Mobile Number" required="">
<h3 style="color: red">*This mobile number will also updated to your profile</h3>
</div>
<div class="right-div">
<h3 style="color: red">*If you enter wrong transaction id then your order will we can cancel!</h3>
<button type="submit" class="button">Procced to generate bill <i class='far fa-arrow-alt-circle-right'></i></button>
